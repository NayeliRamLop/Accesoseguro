{{-- resources/views/boletos/escaneados.blade.php --}}
@extends('adminlte::page')

@section('title', 'Boletos escaneados')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Boletos escaneados</h1>
...
@section('content')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('boletos.escaneados') }}" class="form-inline">
                ...
                <a href="{{ route('boletos.escaneados') }}" class="btn btn-outline-secondary ml-2">
                    Limpiar filtros
                </a>
            </form>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if ($boletos->isEmpty())
                <p>No hay boletos escaneados con el filtro seleccionado.</p>
            @else
